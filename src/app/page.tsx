...
export default function Home() {
  ...
  const downloadApp = async () => {
    ...
    link.href = "/my-app.apk"; // path relative to public folder
    link.download = "my-app.apk"; // this is optional, it will force download
  ...
  return (
    <>
      {isMobile ? (
        ...
        <Box
          sx={{ background: "linear-gradient(to bottom, #f8f9fb, #f0f1f5)" }}
        >
          ...
          <Container sx={{ height: "100vh" }}>
            ...
            >
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                Revolutionize how you monitor, analyze, and manage crowds with
                our AI-powered platform. Ensure safety, optimize flow, and
